		...
		try {
			...
			FileWriter fr = new FileWriter("vulInfo.txt");
				...
				while (reportHostItrt.hasNext()) {
					...
					// String testH = "172.20.10.7"; // test 

					System.out.println("host name is: "+host.attribute(0).getText()); // org 
					// System.out.println("host name is: "+testH); // test 
					...
					//	System.out.println("attribute count is: "+sube.attributeCount());
						...
						//		System.out.println(reportItemElement.getName());
							...
							while(itr.hasNext()){
								...
								System.out.println();
								// testing 
								// System.out.println("check output : \n host name "+host.attribute(0).getText()+" | port number : "+sube.attribute(0).getText()+" | protocol : "+sube.attribute(2).getText());
