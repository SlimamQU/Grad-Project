...
rm connectionSucc.txt xsb_nessus_translate.log xsb_vul_summary.log grps_nessus.P results.xwam summ_nessus.P vulInfo.txt nessus.P results.P accountinfo.P
